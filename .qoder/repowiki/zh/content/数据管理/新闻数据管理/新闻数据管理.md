...
## 更新摘要
**变更内容**
- 新增NewsDetailCrawler详情页爬虫系统，提供更准确的新闻资讯抓取功能
- 支持多个碳市场新闻网站源，包含URL提取、内容过滤、日期标准化等高级功能
- 更新数据获取机制，从列表页爬虫转向详情页爬虫获取真实URL
- 增强新闻数据结构，支持摘要、来源标注和标签系统
- 完善自动化数据更新流程，集成详情页爬虫功能
...
NEWS_DETAIL_CRAWLER["newsDetailCrawler.ts"]
HTTP_CLIENT["httpClient.ts"]
UPDATE_DATA["updateData.ts"]
AUTO_UPDATE["autoUpdate.ts"]
TEST_CRAWLER["testCrawler.ts"]
end
subgraph "数据更新"
INDEX_CRAWLER["crawler/index.ts"]
END
MAIN --> APP
APP --> NEWS_SECTION
...
NEWS_SECTION --> TYPES
NEWS_DETAIL_CRAWLER --> BASE_CRAWLER
NEWS_DETAIL_CRAWLER --> HTTP_CLIENT
UPDATE_DATA --> NEWS_DETAIL_CRAWLER
AUTO_UPDATE --> UPDATE_DATA
TEST_CRAWLER --> NEWS_DETAIL_CRAWLER
INDEX_CRAWLER --> NEWS_DETAIL_CRAWLER
```
...
- [newsDetailCrawler.ts:1-197](file://scripts/crawler/newsDetailCrawler.ts#L1-L197)
...
- [testCrawler.ts:1-52](file://scripts/testCrawler.ts#L1-L52)
...
- **新闻详情页爬虫系统**：基于基类爬虫实现，支持4个主要碳市场新闻平台的详情页抓取，包含URL提取、内容过滤、日期标准化等高级功能。
...
- [index.ts:55-64](file://src/types/index.ts#L55-L64)
- [news.ts:1-109](file://src/data/news.ts#L1-L109)
- [newsDetailCrawler.ts:46-89](file://scripts/crawler/newsDetailCrawler.ts#L46-L89)
- [NewsSection.tsx:1-110](file://src/sections/NewsSection.tsx#L1-L110)
- [LinkValidator.tsx:1-348](file://src/components/LinkValidator.tsx#L1-L348)
- [SectionCard.tsx:1-25](file://src/components/SectionCard.tsx#L1-L25)
...
participant NewsDetailCrawler as "newsDetailCrawler.ts"
...
UpdateData->>NewsDetailCrawler : 抓取新闻详情数据
NewsDetailCrawler->>BaseCrawler : 继承基类功能
BaseCrawler->>HttpClient : 使用HTTP客户端
HttpClient-->>BaseCrawler : 返回响应数据
BaseCrawler-->>NewsDetailCrawler : 返回解析结果
NewsDetailCrawler-->>UpdateData : 返回新闻数组
...
- [newsDetailCrawler.ts:57-89](file://scripts/crawler/newsDetailCrawler.ts#L57-L89)
...
### 新闻详情页爬虫系统与数据获取机制
- **爬虫平台扩展**
  - 支持4个主要碳市场新闻平台：中国碳交易网、碳道、上海环境能源交易所、北京绿色交易所
  - 每个平台都有对应的URL配置和解析规则
  - 使用正则表达式精确匹配文章URL模式
- **数据抓取流程**
  - 并行抓取所有平台数据，提高效率
...
```mermaid
flowchart TD
Start(["开始详情页爬取"]) --> Parallel["并行处理4个平台"]
...
Fetch1 --> Extract1["提取文章URL"]
Fetch2 --> Extract2["提取文章URL"]
Fetch3 --> Extract3["提取文章URL"]
Fetch4 --> Extract4["提取文章URL"]
Extract1 --> Detail1["解析详情页"]
Extract2 --> Detail2["解析详情页"]
Extract3 --> Detail3["解析详情页"]
Extract4 --> Detail4["解析详情页"]
Detail1 --> Filter1["关键词检测"]
Detail2 --> Filter2["关键词检测"]
Detail3 --> Filter3["关键词检测"]
Detail4 --> Filter4["关键词检测"]
Filter1 --> Clean1["清理文本"]
Filter2 --> Clean2["清理文本"]
Filter3 --> Clean3["清理文本"]
Filter4 --> Clean4["清理文本"]
...
Normalize1 --> Summary1["提取摘要"]
Normalize2 --> Summary2["提取摘要"]
Normalize3 --> Summary3["提取摘要"]
Normalize4 --> Summary4["提取摘要"]
Summary1 --> Validate1["验证标题长度"]
Summary2 --> Validate2["验证标题长度"]
Summary3 --> Validate3["验证标题长度"]
Summary4 --> Validate4["验证标题长度"]
Validate1 --> Push1["添加到结果集"]
Validate2 --> Push2["添加到结果集"]
Validate3 --> Push3["添加到结果集"]
Validate4 --> Push4["添加到结果集"]
Push1 --> Sort["按日期排序"]
Push2 --> Sort
Push3 --> Sort
Push4 --> Sort
...
**图表来源**
- [newsDetailCrawler.ts:57-89](file://scripts/crawler/newsDetailCrawler.ts#L57-L89)
- [newsDetailCrawler.ts:94-110](file://scripts/crawler/newsDetailCrawler.ts#L94-L110)
- [newsDetailCrawler.ts:115-149](file://scripts/crawler/newsDetailCrawler.ts#L115-L149)
- [newsDetailCrawler.ts:154-157](file://scripts/crawler/newsDetailCrawler.ts#L154-L157)
- [newsDetailCrawler.ts:162-171](file://scripts/crawler/newsDetailCrawler.ts#L162-L171)
- [newsDetailCrawler.ts:176-182](file://scripts/crawler/newsDetailCrawler.ts#L176-L182)

**章节来源**
- [newsDetailCrawler.ts:46-89](file://scripts/crawler/newsDetailCrawler.ts#L46-L89)
- [newsDetailCrawler.ts:94-189](file://scripts/crawler/newsDetailCrawler.ts#L94-L189)
...
CrawlAll->>NewsDetailCrawler : 抓取新闻详情数据
NewsDetailCrawler-->>CrawlAll : 返回新闻数组
...
- [index.ts:28-59](file://scripts/crawler/index.ts#L28-L59)
...
### 扩展方式、新增频道支持与内容聚合策略
- **新增频道**
  - 在 newsDetailCrawler.ts 中的 NEWS_SOURCES 数组增加新的平台配置
...
**章节来源**
- [newsDetailCrawler.ts:18-44](file://scripts/crawler/newsDetailCrawler.ts#L18-L44)
...
NEWS_DETAIL_CRAWLER["newsDetailCrawler.ts"] --> BASE_CRAWLER
UPDATE_DATA["updateData.ts"] --> NEWS_DETAIL_CRAWLER
AUTO_UPDATE["autoUpdate.ts"] --> UPDATE_DATA
TEST_CRAWLER["testCrawler.ts"] --> NEWS_DETAIL_CRAWLER
INDEX_CRAWLER["crawler/index.ts"] --> NEWS_DETAIL_CRAWLER
```
...
- [NewsSection.tsx:12-45](file://src/sections/NewsSection.tsx#L12-L45)
- [LinkValidator.tsx:212-225](file://src/components/LinkValidator.tsx#L212-L225)
- [newsDetailCrawler.ts:47-55](file://scripts/crawler/newsDetailCrawler.ts#L47-L55)
- [httpClient.ts:26-66](file://scripts/utils/httpClient.ts#L26-L66)
...
- [newsDetailCrawler.ts:83-85](file://scripts/crawler/newsDetailCrawler.ts#L83-L85)
- [package.json:12-19](file://package.json#L12-L19)

## 结论
本项目以清晰的模块划分实现了新闻数据的本地化生成、展示与基础校验。通过类型约束与组件化设计，具备良好的可维护性与扩展性。最新的更新引入了完整的详情页爬虫系统，实现了从4个主要碳市场新闻平台自动抓取真实数据的功能，并建立了自动化数据更新和简报发送流程。建议后续在以下方向深化：
...
- **相关文件路径**
  ...
  - 新闻详情页爬虫：[crawler/newsDetailCrawler.ts:1-197](file://scripts/crawler/newsDetailCrawler.ts#L1-L197)
  - HTTP客户端：[utils/httpClient.ts:1-115](file://scripts/utils/httpClient.ts#L1-L115)
  - 数据更新：[updateData.ts:1-194](file://scripts/updateData.ts#L1-L194)
  - 自动更新：[autoUpdate.ts:1-53](file://scripts/autoUpdate.ts#L1-L53)
  - 爬虫入口：[crawler/index.ts:1-60](file://scripts/crawler/index.ts#L1-L60)
  - 测试脚本：[testCrawler.ts:1-52](file://scripts/testCrawler.ts#L1-L52)

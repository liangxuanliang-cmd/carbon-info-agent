...
系统支持多种交通出行方式，包括公共交通、轨道交通、骑行、步行、新能源汽车和传统燃油汽车，并根据用户所在地区提供相应的基准排放因子和情景排放因子。
...
**章节来源**
- [emissionFactors.ts:3-103](file://src/data/emissionFactors.ts#L3-L103)
...
排放因子数据采用JSON配置格式，支持多地区、多交通方式的灵活扩展：
...
| 厦门市 | 低碳出行碳普惠方法学 | 6种 |
| 南昌市 | 低碳出行碳普惠方法学 | 5种 |
| 广东省 | 汽油乘用车用导行低碳出行方法学 | 6种 |
| 北京市 | 碳普惠项目减排量核算技术规范(DB11/T 3043—2024)&油改电小客车方法学(2025版) | 5种 |
| 重庆市 | 低碳出行碳普惠方法学 | 5种 |
| 福州市 | 低碳出行碳普惠方法学 | 4种 |
| 深圳市 | 低碳出行碳普惠方法学 | 6种 |
| 杭州市 | 低碳出行碳普惠方法学 | 5种 |
...
**章节来源**
- [emissionFactors.ts:4-52](file://src/data/emissionFactors.ts#L4-L52)
